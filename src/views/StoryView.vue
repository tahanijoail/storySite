...
import nameClass from 'tailwindcss-rtl/src/util/nameClass';
...
<div class="max-w-[55%] rounded-2xl overflow-hidden mx-auto ">
  ...
  <RouterLink to="/FavoritetoriesS" class="flex items-center gap-2 bg-amber-400 text-black font-medium py-2 px-4 rounded-xl shadow-md hover:bg-amber-500 transition duration-300">
    <span class="text-lg">اضافة الى المفضلة</span>
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 " fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" >
      <path stroke-linecap="round" stroke-linejoin="round" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
    </svg>
   
  </RouterLink>
  <RouterLink to="/listining_story"  class="bg-amber-400 hover:bg-amber-500 rounded-full"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
